            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="hero__categories">
                        <h4 class="widget-title">Shop by</h4>
                ...
                <div class="col-lg-9">
                    ...
                    <!-- SubCategory -->
                    <div class="hero__item set-bg" data-setbg="admin/shopping_images/surface-pro.jpg">
                    
                    <div class="hero__text">
                    <span>COMPUTER FIELD</span>
                    <h2>SubCategory <br />100% Organic</h2>
                    ...
                    while($row=mysqli_fetch_array($sql)){
                    ?>
                        <a href="#" class="primary-btn"><?php echo htmlentities($row['subcategory']);?></a>  
                    <?php } ?>
                    </div>  
                    </div>
                </div>
