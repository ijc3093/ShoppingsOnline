                    ...
                    <div class="hero__categories">
                        ...
                        <!-- Look at category from sql-->
                            ...
                            while($row=mysqli_fetch_array($sql)){
                                ?>
                        <ul>
                            <!-- Look at when you click this to next page (sub-category.php)-->
...
<!--                        <h6>Shop by</h6>-->
                ...
                <div class="col-lg-9">
                    ...
                    <!-- Category -->
                    <div class="hero__item set-bg" data-setbg="admin/shopping_images/iPhone.jpg">
                        <div class="hero__text">
                            <span>COMPUTER FIELD</span>
                            <h2>Category <br />100% Organic</h2>
                            <p>Free Pickup and Delivery Available</p>
                            <!--Look at the name of product at the big image -->
                            <?php $sql=mysqli_query($con,"select categoryName  from category where id='$cid'");
                                    while($row=mysqli_fetch_array($sql)){
                            ?>
                            <a href="#" class="primary-btn"><?php echo htmlentities($row['categoryName']);?></a>
    ...
    <section class="featured spad">
        <div class="container">
            ...
            <div class="row featured__filter">
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix fastfood vegetables"> <h3>No Product Found</h3>
                </div>
                <?php } ?>
            </div>
        </div>
